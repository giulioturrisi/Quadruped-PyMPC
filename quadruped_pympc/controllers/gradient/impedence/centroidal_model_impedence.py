...
class Centroidal_Model_Impedence:
    def __init__(self,) -> None: 
        ...
        foot_force_fr_z = cs.SX.sym("foot_force_fr_z", 1, 1)
        foot_force_rl_z = cs.SX.sym("foot_force_rl_z", 1, 1)
        foot_force_rr_z = cs.SX.sym("foot_force_rr_z", 1, 1)
    ...
    def export_robot_model(self,) -> AcadosModel:
        ...
        acados_model.name = "centroidal_model_impedence"
