...
if __name__ == '__main__':
    ...
    elif cfg.mpc_params['type'] == 'impedence':
        from quadruped_pympc.controllers.gradient.impedence.centroidal_nmpc_impedence import Acados_NMPC_Impedence

        controller = Acados_NMPC_Impedence()
